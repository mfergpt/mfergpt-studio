...
export default function Avatars() {
  ...
  return (
    <div>
      ...
      {/* OG Collection — AR viewer */}
      <div className="bg-[#111] border border-[#222] rounded-xl p-8 mb-6">
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1">
            <h2 className="sartoshi-font text-3xl text-white mb-4">mfer avatars collection</h2>
            <p className="text-gray-400 mb-4">
              the full 10,021 OG mfers as 3D avatars — plus more. browse, view in AR on your phone, and explore the collection.
            </p>
            <a
      ...
      {/* Playground — create your own */}
      <div className="bg-[#111] border border-[#222] rounded-xl p-6 mb-6">
        <div className="flex items-center gap-4">
          <span className="text-3xl">🔨</span>
          <div className="flex-1">
            <h3 className="sartoshi-font text-xl text-white mb-1">playground</h3>
            <p className="text-gray-400 text-sm">create your own custom 3D mfer avatar. export as GLB or PNG.</p>
          </div>
          <a
